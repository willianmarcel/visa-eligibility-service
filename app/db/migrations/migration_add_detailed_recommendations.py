...
from app.models.assessment import QuickAssessment
...
def up():
    ...
    """
    db_logger.info("Iniciando migração para adicionar campos detalhados")
    ...
    db_session.commit()
    db_logger.info(f"Migração concluída. {count} registros atualizados.")
...
def down():
    ...
    """
    db_logger.info("Iniciando reversão da migração")
    ...
    # Commit das alterações
    db_session.commit()
    db_logger.info(f"Reversão concluída. {count} registros revertidos.")
